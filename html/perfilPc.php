  ...
  <body onload="initialize()">
	...
	<body>
		...
		<h2>Dados pessoais</h2>
			...
			<?php echo ($_SESSION["usuario"]["foto"] == NULL ? "<img src=../img/perfilSemFoto.png>" : "<img class=foto src=../php-img/fotoPerfilPc/" . $_SESSION["usuario"]["foto"] . ">"); ?> <br><br>
		</div>

		<form action="../php/perfilPc/fotoPerfil.php" method="POST" enctype="multipart/form-data">
		<div class="foto"> <input type="file" name="fotoPerfil"> </div>
			<input class="botoes" type="submit" name="enviarFoto" value="Enviar foto">
		</form>

		<br>

		<form action="../php/perfilPc/logout.php" method="POST">
			<input class="botoes" type="submit" name="logout" value="Sair">
		</form>
			
		<form action="../php/perfilPc/excluirConta.php" method="POST">
